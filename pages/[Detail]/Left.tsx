...
function Left({data} : any) {
  return (
    <div className='w-[100px]  h-[93vh]  fcc  animate-slideup42 items-center justify-end fixed bottom-0'>
          ...
          <a href={data?.Backend_Repo_Link} className='mb-[20px] hover:scale-125 relative group transition-all duration-75'>
          <div className='w-auto text-[8px] absolute left-[-13px] hidden group-hover:flex ml-[3px] top-[-20px] animate-slideup 
                               rounded-[20px] bg-black frc pl-[8px] pr-[8px] py-[1px] '>Backend</div>
            <GoMarkGithub className='text-[28px] text-gray-700   cursor-pointer'/>
        </a>
