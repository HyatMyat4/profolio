  ...
  return (
           <div  id='Projects' className='mt-[20px] 600:mt-0'>
            {Projectdata.map((data : Project) => (
                   <section  id={data.PROJECT_SHORT_NAME}  className='w-full 400:h-[93vh] frc my-[40px]  400:my-0   '>
                   <div id='monospace' className='w-full h-auto bg-slate-200 dark:bg-[#1e2439] rounded-[5px] shadow-lg '>
                       <div className='w-[98%] h-auto rounded-[5px] relative group overflow-hidden  cursor-pointer  m-auto my-[8px]'>
                         ...
                         <div className='w-full h-full hidden 800:flex bg-slate-200 dark:bg-[#000000e2]  relative   animate-slidelefttranfrom  z-50 frc justify-center  '>
                            ...
                            <div className={`w-[50px] ${data.mui === "" ? " opacity-0"  : "" } h-auto rotate-[55deg] translate-y-[0px] translate-x-[105px]`}>
                       ...
                       <div className='p-[20px] pt-[10px] '>
                          <span id='monospace' className=' animate-slideleft2 text-[20px] text-teal-400'>{data.PROJECT_NAME}</span>
                          ...
                          <div className='w-full h-[60px] frc justify-end'>
                            ...
                            <a href={data.Backend_Repo_Link} className={`w-auto relative ${data.Backend_Repo_Link === "" ? "hidden" : " "} group`}>
