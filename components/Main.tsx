...
function Main() {
  ...
  return (
    <div className=" w-full 800:w-[800px] h-[93vh] z-0 m-auto p-[15px] 1000:p-0  ">
      <section
        id="section1"
        className="w-full 400:h-[91vh] mt-[3vh] frc my-[40px]  400:my-0 "
      >
        <div className="w-full h-auto fcc items-start">
          ...
          <p className=" text-[20px]">
            ...
            I am proficient in designing and implementing complex features for{" "}
            <span className="text-sky-500"> websites </span> ,
          ...
          <div className="px-[35px] py-[12px] border hover:scale-110 transition-all duration-75 cursor-pointer border-teal-400 mt-[30px] rfc justify-center   rounded-[5px]">
            <a href="/resume.pdf" className=" text-teal-400">Resume</a>
          </div>
        </div>
      </section>
      <About />
