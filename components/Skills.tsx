      ...
      <div className="w-full h-full fcc  items-start justify-center">
        ...
        <div className="w-full h-auto rounded-[5px]  fcc items-start  cursor-pointer bg-[#282A36] mb-[15px]">
          ...
          <div className="w-full h-auto fcc  items-start">
            <span className="w-full h-auto px-[18px] text-[17px] text-white ">
              ...
              <span className="  text-teal-400 text-[16px]">Frontend</span>{" "}
        ...
        <div className="w-full h-auto rounded-[5px] fcc items-start mb-[15px]  cursor-pointer   bg-[#282A36]">
          ...
          <div className="w-full h-auto fcc  items-start">
            <span className="w-full h-auto px-[18px] text-[17px] text-white ">
              <span className=" text-pink-600 font-bold "> const </span>
              <span className="  text-teal-400 text-[15px]">Backend</span>{" "}
              <span className=" text-orange-600">=</span>
              <span className=" text-blue-600"> [ </span>
              <span className="text-teal-400  text-[17px]">
                {" "}
        ...
        <div className="w-full h-auto rounded-[5px] fcc items-start    bg-[#282A36]">
          ...
          <div className="w-full h-auto fcc  items-start">
            <span className="w-full h-auto px-[18px] text-[17px] text-white ">
              <span className=" text-pink-600 font-bold "> const </span>
              <span className="  text-teal-400 text-[15px]">
                MobileApp
              </span>{" "}
              <span className=" text-orange-600">=</span>
              <span className=" text-blue-600"> [ </span>{" "}
              <span className="text-teal-400">
                <span className="text-teal-400  inline  group-hover:hidden text-[17px]">
                  {" "}
            ...
            <span className="w-full h-auto px-[18px] text-[17px] text-white ">
              <span className=" text-pink-600 font-bold "> const </span>
              <span className="  text-teal-400 text-[15px] mt-[10px] ">
                DasktopSoftware
              </span>{" "}
              <span className=" text-orange-600">=</span>
              <span className=" text-blue-600"> [ </span>{" "}
              <span className="text-teal-400"> Electronjs </span> ,{" "}
              <span className="text-teal-400"> Tauri </span>
              <span className=" text-blue-600">]</span>
            </span>
